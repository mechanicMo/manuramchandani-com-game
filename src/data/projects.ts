...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagColor: '#2D6A4F',
    tagBg: '#D8F3DC',
    shortDesc: 'Point your phone at a grocery receipt. Get a week of recipes back.',
    fullDesc: "Meal Planner turns a grocery receipt into a week of recipes. You snap a photo of your receipt, Gemini AI reads the ingredients, and generates a full meal plan with recipes and a shopping list for anything missing. Built in Flutter with Firebase for user accounts and receipt history.",
    platform: 'Flutter · iOS & Android',
    stack: ['Flutter', 'Firebase', 'Gemini AI'],
    problem: "You bought groceries. Now what? Most recipe apps start from the recipe and tell you what to buy. This one starts from what you already have.",
    whatShipped: 'Receipt photo parsing via Gemini Vision, ingredient extraction, full meal plan generation, shopping list for gaps, recipe history.',
    whatWasHard: "Getting Gemini Vision to reliably parse handwritten and thermally-printed receipts across different grocery store formats — the text is messy and the layout varies wildly.",
  },
  {
    slug: 'workshops',
    name: 'Workshops',
    ...
    tagColor: '#7B5E00',
    tagBg: '#FFF3CD',
    shortDesc: 'E-learning platform for modern web development — video chapters, quizzes, progress tracking.',
    fullDesc: "Workshops is an e-learning platform built to teach what I've learned in 14 years building web products. Courses cover React, TypeScript, Supabase, and modern web dev patterns. Each course has video chapters, quizzes, and progress tracking. Built with Lovable and Supabase.",
    platform: 'Web',
    stack: ['Lovable', 'Supabase', 'React', 'TypeScript'],
    problem: "Most web dev courses are either too beginner or too abstract. These are the patterns I use in production, taught from first principles.",
    whatShipped: 'Course authoring system, video chapters with progress tracking, quizzes with branching feedback, user enrollment and progress persistence via Supabase.',
    whatWasHard: "Building a quiz system that gives useful branching feedback without becoming a decision tree nightmare. The state machine for quiz flow took several iterations.",
  },
];
